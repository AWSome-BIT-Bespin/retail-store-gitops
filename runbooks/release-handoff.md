...
마지막으로 확인한 전체 게시 증거는 [run 34305372158](https://github.com/AWSome-BIT-Bespin/retail-store-app/actions/runs/34305372158), 앱 소스 `0c89f755de72bc699629300c17fb307bda87c200`이다. 이것은 이후 변경의 게시나 현재 Pod 상태를 보증하지 않는다.
...
현재 GitOps 버전 기록은 Cart v0.0.2, Catalog v0.0.2, Checkout v0.0.3, Orders v0.1.1, UI v0.1.6이다. 별도 로컬 앱 브랜치의 Catalog v0.0.3·Checkout v0.0.4·UI v0.1.7 후보는 아직 정식 게시 완료로 취급하지 않는다. 이번 CD 준비에서는 버전 기록을 올리지 않는다.
